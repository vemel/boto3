...
class BaseTransformationTest(unittest.TestCase):
    ...
    def setup_models(self):
        self.json_model = {
            ...
            "shapes": {
                "SampleOperationInputOutput": {"type": "structure", "members": {}},
                "String": {"type": "string"},
            },
        }
...
class TestInputOutputTransformer(BaseTransformationTest):
    ...
    def test_transform_structure(self):
        input_params = {
            "Structure": {"TransformMe": self.original_value, "LeaveAlone": self.original_value,}
        }
        input_shape = {
            "Structure": {
                "type": "structure",
    ...
    def test_transform_map(self):
        ...
        untargeted_input_shape = {
            "LeaveAlone": {"type": "map", "key": {"shape": "String"}, "value": {"shape": "String"},}
        }
    ...
    def test_transform_list(self):
        ...
        targeted_input_shape = {
            "TransformMe": {"type": "list", "member": {"shape": self.target_shape}}
        }

        untargeted_input_shape = {"LeaveAlone": {"type": "list", "member": {"shape": "String"}}}
    ...
    def test_transform_nested_list(self):
        input_params = {
            "TargetedWrapperList": [[self.original_value, self.original_value]],
            "UntargetedWrapperList": [[self.original_value, self.original_value]],
        }
        ...
        targeted_wrapper_shape = {
            "TargetedWrapperList": {"type": "list", "member": {"shape": "TransformMe"}}
        }

        self.add_shape(targeted_list_shape)
        self.add_input_shape(targeted_wrapper_shape)

        untargeted_list_shape = {"LeaveAlone": {"type": "list", "member": {"shape": "String"}}}

        untargeted_wrapper_shape = {
            "UntargetedWrapperList": {"type": "list", "member": {"shape": "LeaveAlone"}}
        }
        ...
        self.assertEqual(
            input_params,
            {
                "TargetedWrapperList": [[self.transformed_value, self.transformed_value]],
                "UntargetedWrapperList": [[self.original_value, self.original_value]],
            },
        )
    ...
    def test_transform_incorrect_type_for_structure(self):
        ...
        input_shape = {
            "Structure": {
                "type": "structure",
                "members": {"TransformMe": {"shape": self.target_shape},},
            }
        }
    ...
    def test_transform_incorrect_type_for_list(self):
        ...
        input_shape = {"List": {"type": "list", "member": {"shape": self.target_shape}}}
...
class TestTransformAttributeValueInput(BaseTransformAttributeValueTest):
    def test_handler(self):
        input_params = {"Structure": {"TransformMe": self.python_value, "LeaveAlone": "unchanged"}}
        input_shape = {
            "Structure": {
                "type": "structure",
                "members": {
        ...
        self.injector.inject_attribute_value_input(params=input_params, model=self.operation_model)
        self.assertEqual(
            input_params,
            {"Structure": {"TransformMe": self.dynamodb_value, "LeaveAlone": "unchanged",}},
        )


class TestTransformAttributeValueOutput(BaseTransformAttributeValueTest):
    def test_handler(self):
        parsed = {"Structure": {"TransformMe": self.dynamodb_value, "LeaveAlone": "unchanged"}}
        input_shape = {
            "Structure": {
                "type": "structure",
                "members": {
        ...
        self.add_input_shape(input_shape)
        self.injector.inject_attribute_value_output(parsed=parsed, model=self.operation_model)
        self.assertEqual(
            parsed, {"Structure": {"TransformMe": self.python_value, "LeaveAlone": "unchanged",}},
        )
    ...
    def test_no_output(self):
        service_model = ServiceModel(
            {
                ...
                "shapes": {
                    "SampleOperationInput": {"type": "structure", "members": {}},
                    "String": {"type": "string"},
                },
            }
        )
        ...
        parsed = {}
        self.injector.inject_attribute_value_output(parsed=parsed, model=operation_model)
...
class TestTransformConditionExpression(BaseTransformationTest):
    ...
    def test_non_condition_input(self):
        ...
        self.injector.inject_condition_expressions(params, self.operation_model)
        self.assertEqual(params, {"KeyCondition": "foo", "AttrCondition": "bar"})
    ...
    def test_key_and_attr_conditon_expression_with_placeholders(self):
        ...
        self.assertEqual(
            params,
            {
                "KeyCondition": "#n1 = :v1",
                "AttrCondition": "#n0 = :v0",
                "ExpressionAttributeNames": {"#n0": "biz", "#n1": "foo", "#a": "b"},
                "ExpressionAttributeValues": {":v0": "baz", ":v1": "bar", ":c": "d"},
            },
        )
...
class TestDynamoDBHighLevelResource(unittest.TestCase):
    ...
    def test_instantiation(self):
        ...
        dynamodb_class = type("dynamodb", (DynamoDBHighLevelResource,), {"meta": self.meta})
        with mock.patch("boto3.dynamodb.transform.TransformationInjector") as mock_injector:
            with mock.patch(
