                ...
                "actions": {
                    ...
                    "SampleListReturnOperation": {
                        ...
                        "resource": {
                            "type": "Sample",
                            "identifiers": [
                                {"target": "Name", "source": "response", "path": "Samples[].Name",}
                            ],
                            "path": "Samples[]",
                        },
                    },
                ...
                "hasMany": {
                    "Samples": {
                        ...
                        "resource": {
                            "type": "Sample",
                            "identifiers": [
                                {"target": "Name", "source": "response", "path": "Samples[].Foo",}
                            ],
                        },
                    }
                },
                    ...
                    "actions": {
                        "Operate": {
                            "request": {
                                "operation": "SampleOperation",
                                "params": [
                                    {"target": "Foo", "source": "identifier", "name": "Name",}
                                ],
                            }
                        }
                    },
                    ...
                    "has": {
                        "RelatedSample": {
                            "resource": {
                                "type": "Sample",
                                "identifiers": [
                                    {"target": "Name", "source": "data", "path": "Foo"}
                                ],
                            }
                        }
                    },
