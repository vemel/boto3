...
class TestResourceDocstrings(BaseDocsTest):
    ...
    def test_identifier_help(self):
        ...
        self.assert_contains_lines_in_order(
            ["    *(string)* The Sample's name identifier. This " "**must** be set."],
    ...
    def test_reference_help(self):
        ...
        self.assert_contains_lines_in_order(
            ["    (:py:class:`Sample`) The related related_sample " "if set, otherwise ``None``."],
            reference_docstring,
        )
    ...
    def test_collection_help(self):
        ...
        self.assert_contains_lines_in_order(
            ["    A collection of Sample resources"], collection_method_docstring
        )
    ...
    def test_collection_all_method_help(self):
        ...
        self.assert_contains_lines_in_order(
            [
                ("    Creates an iterable of all Sample resources in the " "collection."),
                "    **Request Syntax** ",
                "    ::",
