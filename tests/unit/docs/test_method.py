...
class TestDocumentModelDrivenResourceMethod(BaseDocsTest):
    ...
    def test_returns_resource(self):
        ...
        resource_action._resource = ResponseResource(
            {
                "type": "Sample",
                "identifiers": [{"target": "Name", "source": "requestParameter", "path": "Foo"}],
            },
    ...
    def test_include_input(self):
        include_params = [DocumentedShape(name="Biz", type_name="string", documentation="biz docs")]
        document_model_driven_resource_method(
            self.doc_structure,
            "foo",
            self.operation_model,
    ...
    def test_exclude_input(self):
        ...
        self.assert_not_contains_lines([":param Bar: string", "Bar='string'"])
