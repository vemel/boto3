...
class TestSession(BaseTestCase):
    ...
    def test_can_access_region_name(self):
        ...
        bc_session.get_config_variable.return_value = "us-west-2"
        session = Session("abc123", region_name="us-west-2")
        bc_session.set_config_variable.assert_called_with("region", "us-west-2")
    ...
    def test_arguments_not_required(self):
        ...
        self.assertTrue(self.bc_session_cls.called, "Botocore session was not created")
    ...
    def test_get_available_services(self):
        ...
        self.assertTrue(
            bc_session.get_available_services.called,
    ...
    def test_get_available_regions(self):
        ...
        bc_session.get_available_regions.assert_called_with(
            service_name="myservice", partition_name="aws", allow_non_regional=False
        )
        self.assertEqual(partitions, ["foo"])
    ...
    def test_create_resource_latest_version(self):
        ...
        loader.load_service_model.assert_called_with("sqs", "resources-1", None)
