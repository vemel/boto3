...
class TestResourceFactory(BaseTestResourceFactory):
    ...
    def test_factory_creates_properties(self):
        model = {
            "shape": "TestShape",
            "load": {"request": {"operation": "DescribeTest",}},
        }
        shape = (
    ...
    def test_can_instantiate_service_resource(self):
        ...
        self.assertIsInstance(
            resource, ServiceResource, "Object is not an instance of ServiceResource"
        )
    ...
    def test_resource_meta_unique(self):
        ...
        self.assertNotEqual(
            queue1.meta, queue2.meta, "Queue data should be unique to queue instance"
        )
    ...
    def test_resource_meta_repr(self):
        queue_cls = self.load("Queue")
        queue = queue_cls()
        self.assertEqual(repr(queue.meta), "ResourceMeta('test', identifiers=[])")
    ...
    @mock.patch("boto3.resources.factory.ServiceAction")
    def test_resource_action_leaves_data(self, _action_cls):
    ...
    def test_resource_lazy_loads_properties(self, action_cls):
            ...
            .with_members(
                {
                    ...
                    "LastModified": {"type": "string", "shape_name": "LastModified"},
        ...
        self.assertEqual(resource.e_tag, "tag", "ETag property returned wrong value")
    ...
    def test_resource_lazy_properties_missing_load(self, action_cls):
        ...
        with self.assertRaises(ResourceLoadException):
            _ = resource.last_modified

    @mock.patch("boto3.resources.factory.ServiceAction")
    def test_resource_aliases_identifiers(self, _action_cls):
        model = {
            "shape": "TestShape",
        ...
        shape = (
            DenormalizedStructureBuilder()
            .with_members({"foo_id": {"type": "string",}, "bar": {"type": "string"},})
            .build_model()
        )
        service_model = mock.Mock()
        service_model.shape_for.return_value = shape
        ...
        shape_id = "baz"
        resource = self.load("test", model, service_model=service_model)(shape_id)
    ...
    def test_resource_loads_references(self):
        ...
        resource = self.load("Instance", model, defs, service_model)("group-id")
    ...
    def test_resource_loads_waiters(self):
        ...
        self.assertTrue(
            hasattr(resource, "wait_until_exists"),
...
class TestResourceFactoryDanglingResource(BaseTestResourceFactory):
    ...
    def test_dangling_resources_create_resource_instance(self):
        ...
        self.assertIsInstance(
            q, ServiceResource, "Dangling resource instance not a ServiceResource"
        )
    ...
    def test_dangling_resource_inequality(self):
        self.defs = {
            ...
            "Message": {"identifiers": [{"name": "QueueUrl"}, {"name": "Handle"}]},
        }
    ...
    def test_dangling_resource_loads_data(self):
        ...
        shape = (
            DenormalizedStructureBuilder()
            .with_members({"Id": {"type": "string",}, "PublicIp": {"type": "string"}})
            .build_model()
        )
        service_model = mock.Mock()
        service_model.shape_for.return_value = shape
