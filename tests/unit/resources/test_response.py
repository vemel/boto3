...
class TestBuildIdentifiers(BaseTestCase):
    def test_build_identifier_from_res_path_scalar(self):
        ...
        self.assertEqual(
            values[0][1], "response-path", "Identifier loaded from responsePath scalar not set",
        )
    ...
    def test_build_identifier_from_res_path_list(self):
        ...
        self.assertEqual(
            values[0][1], ["response-path"], "Identifier loaded from responsePath list not set",
        )
    ...
    def test_build_identifier_from_parent_identifier(self):
        ...
        self.assertEqual(
            values[0][1], "identifier", "Identifier loaded from parent identifier not set",
        )
    ...
    def test_build_identifier_from_parent_data_member(self):
        ...
        self.assertEqual(
            values[0][1], "data-member", "Identifier loaded from parent data member not set",
        )
    ...
    def test_build_identifier_from_req_param(self):
        ...
        self.assertEqual(
            values[0][1], "request-param", "Identifier loaded from request parameter not set",
        )
...
class TestBuildEmptyResponse(BaseTestCase):
    ...
    def test_empty_structure(self):
        ...
        self.assertIsInstance(response, dict, "Structure should default to empty dictionary")
        self.assertFalse(response.items(), "Dictionary should be empty")
    ...
    def test_empty_list(self):
        ...
        self.assertIsInstance(response, list, "List should default to empty list")
        self.assertFalse(len(response), "List should be empty")
    ...
    def test_empty_map(self):
        ...
        self.assertIsInstance(response, dict, "Map should default to empty dictionary")
        self.assertFalse(response.items(), "Dictionary should be empty")
    ...
    def test_empty_string(self):
        ...
        self.assertIsNone(response, "String should default to None")
    ...
    def test_empty_integer(self):
        ...
        self.assertIsNone(response, "Integer should default to None")
    ...
    def test_empty_unkown_returns_none(self):
        ...
        self.assertIsNone(response, "Unknown types should default to None")
...
class TestRawHandler(BaseTestCase):
    def test_raw_handler_response(self):
        ...
        self.assertEqual(parsed_response, response, "Raw response not passed through unmodified")
    ...
    def test_raw_handler_response_path(self):
        ...
        self.assertEqual(parsed_response, frob, "Search path not processed correctly")
...
class TestResourceHandler(BaseTestCase):
    ...
    def get_resource(self, search_path, response):
        request_resource_def = {
            "type": "Frob",
            "identifiers": [{"target": "Id", "source": "response", "path": self.identifier_path},],
        }
    ...
    def test_create_resource_scalar(self):
        ...
        self.assertIsInstance(
            resource, ServiceResource, "No resource instance returned from handler"
        )
    ...
    def test_missing_data_scalar_builds_empty_response(self, build_mock):
        ...
        self.assertTrue(build_mock.called, "build_empty_response was never called")
        self.assertEqual(
            resources,
    ...
    def test_create_resource_list(self):
        ...
        response = {
            "Container": {
                "Frobs": [
                    {"Id": "a-frob", "OtherValue": "other",},
                    {"Id": "another-frob", "OtherValue": "foo",},
                ]
            }
        }
        ...
        self.assertIsInstance(resources, list, "No list returned from handler")
        self.assertEqual(len(resources), 2, "Exactly two frobs should be returned")
        self.assertIsInstance(
            resources[0], ServiceResource, "List items are not resource instances"
        )
    ...
    def test_create_resource_list_no_search_path(self):
        ...
        self.assertIsInstance(resources, list, "No list returned from handler")
        self.assertEqual(len(resources), 1, "Exactly one frob should be returned")
        self.assertIsInstance(
            resources[0], ServiceResource, "List items are not resource instances"
        )
