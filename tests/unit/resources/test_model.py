...
class TestModels(BaseTestCase):
    ...
    def test_resource_identifiers(self):
        model = ResourceModel(
            "test", {"identifiers": [{"name": "one"}, {"name": "two", "memberName": "three"}]}, {},
        )
                ...
                "actions": {
                    "GetFrobs": {
                        "request": {
                            ...
                            "params": [{"target": "FrobId", "source": "identifier", "name": "Id",}],
                        },
    ...
    def test_resource_action_response_resource(self):
        model = ResourceModel(
            "test",
            {"actions": {"GetFrobs": {"resource": {"type": "Frob", "path": "Container.Frobs[]"}}}},
            {"Frob": {}},
        )
    ...
    def test_resource_load_action(self):
        model = ResourceModel(
            "test", {"load": {"request": {"operation": "GetFrobInfo"}, "path": "$"}}, {}
        )
        ...
        model_def = {
            "has": {
                "Frob": {
                    "resource": {
                        "type": "Frob",
                        "identifiers": [{"target": "Id", "source": "data", "path": "FrobId"}],
                    }
                }
            }
        }
...
class TestRenaming(BaseTestCase):
    def test_multiple(self):
        ...
        shape = (
            ...
            .with_members({"Foo": {"type": "string",}, "Bar": {"type": "string"}})
            .build_model()
        )
    ...
    def test_load_beats_identifier(self):
        model = ResourceModel(
            "test",
            {"identifiers": [{"name": "Load"}], "load": {"request": {"operation": "GetFrobs"}},},
            {},
        )
    ...
    def test_collection_beats_waiter(self):
        model = ResourceModel(
            "test",
            {"hasMany": {"WaitUntilFoo": {"resource": {"type": "Frob"}}}, "waiters": {"Foo": {}},},
            {"Frob": {}},
        )
    ...
    def test_waiter_beats_attribute(self):
        ...
        shape = (
            DenormalizedStructureBuilder()
            .with_members({"WaitUntilFoo": {"type": "string",}})
            .build_model()
        )
