...
class TestBoto3(unittest.TestCase):
    ...
    def test_create_default_session(self):
        ...
        self.assertEqual(boto3.DEFAULT_SESSION, session, "Default session not created properly")
    ...
    def test_client_creates_default_session(self, setup_session):
        ...
        self.assertTrue(setup_session.called, "setup_default_session not called")
        self.assertTrue(
            boto3.DEFAULT_SESSION.client.called, "Default session client method not called",
        )
    ...
    def test_client_uses_existing_session(self, setup_session):
        ...
        self.assertFalse(setup_session.called, "setup_default_session should not have been called")
        self.assertTrue(
            boto3.DEFAULT_SESSION.client.called, "Default session client method not called",
        )
    ...
    def test_resource_creates_default_session(self, setup_session):
        ...
        self.assertTrue(setup_session.called, "setup_default_session not called")
        self.assertTrue(
            boto3.DEFAULT_SESSION.resource.called, "Default session resource method not called",
        )
