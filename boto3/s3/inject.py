...
def inject_bucket_methods(class_attributes: Dict[str, Any], **_kwargs: Any) -> None:
...
def bucket_load(self: BaseClient, *_args: Any, **_kwargs: Any) -> None:
    """
...
def object_summary_load(self: BaseClient, *_args: Any, **_kwargs: Any) -> None:
    """
