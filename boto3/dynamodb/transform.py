...
def register_high_level_interface(base_classes: List[Any], **_kwargs: Any) -> None:
    base_classes.insert(0, DynamoDBHighLevelResource)


def copy_dynamodb_params(params: Any, **_kwargs: Any) -> Any:
...
class TransformationInjector:
    ...
    def inject_condition_expressions(
        self, params: Dict[str, Any], model: OperationModel, **_kwargs: Any
    ) -> None:
    ...
    def inject_attribute_value_output(
        self, parsed: Dict[str, Any], model: OperationModel, **_kwargs: Any
    ) -> None:
...
class ConditionExpressionTransformation:
    ...
    def __init__(
        ...
        placeholder_names: Dict[str, Any],
