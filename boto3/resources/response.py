        ...
        for item in search_path.split("."):
            ...
            if shape.type_name == "structure":
                ...
                raise NotImplementedError(
                    "Search path hits shape type {0} from {1}".format(shape.type_name, item)
                )
...
class ResourceHandler:
    ...
    def __call__(
        ...
        if plural:
            ...
            result = self.handle_response_item(resource_cls, parent, identifiers, search_response)
        else:
            ...
            if self.operation_name is not None:
                ...
                result = build_empty_response(
                    self.search_path, self.operation_name, self.service_context.service_model,
                )
